  ...
  return (
    <>
      <div className='bg-gray-800 p-4 rounded-2xl'>
        <div className={` rounded-full h-12 w-12 p-2 m-2 ${count==0?'bg-red-600 active':'bg-gray-600'}`}></div>
        <div className={` rounded-full h-12 w-12 p-2 m-2 ${count==1?'bg-yellow-600 active':'bg-gray-600'}`}></div>
        <div className={` rounded-full h-12 w-12 p-2 m-2 ${count==2?'bg-green-600 active':'bg-gray-600'} `}></div>
      </div>
    </>
  )
}
